    ...
    {member && ( 
      <div className="flex w-full justify-center flex-1">
        <div className="grid grid-cols-12 w-full md:grid-cols-12 md:w-[90%] lg:w-[66%] border-l-2 border-r-2 py-4 px-4"> 
          <div className="p-4 text-left grid-cols-1 col-span-12 md:col-span-2 md:grid-cols-3">
          ...
          <div className="p-4 grid-cols-1 col-span-12 md:col-span-10 md:grid-cols-9">
